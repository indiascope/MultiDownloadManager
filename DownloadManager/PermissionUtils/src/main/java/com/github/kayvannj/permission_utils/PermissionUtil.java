...
public class PermissionUtil {
    ...
    public static PermissionObject with(Fragment fragment,AppCompatActivity fragmentActivity) {
        return new PermissionObject(fragment,fragmentActivity);
    }
    ...
    public static class PermissionObject {
        ...
        PermissionObject(Fragment fragment,AppCompatActivity fragmentActivity) {
            mFragment = fragment;
        ...
        public boolean has(String permissionName) {
            ...
            if (mActivity != null) {
                ...
                permissionCheck =mFragmentActivity.checkSelfPermission( permissionName);
            }
        ...
        public PermissionRequestObject request(String permissionName) {
            if (mActivity != null) {
                ...
                return new PermissionRequestObject(mFragment, mFragmentActivity ,new String[]{permissionName});
            }
        }
    ...
    static public class PermissionRequestObject {
        ...
        private static final String TAG = PermissionObject.class.getName();
        private AppCompatActivity mActivity;
        ...
        public PermissionRequestObject(Fragment fragment,AppCompatActivity fragmentActivity , String[] permissionNames) {
            mFragment = fragment;
            mFragmentActivity = fragmentActivity;
            mPermissionNames = permissionNames;
        }
        ...
        private boolean needToAsk() {
            ...
            for (int i = 0; i < mPermissionsWeDontHave.size(); i++) {
                ...
                if (mActivity != null) {
                    ...
                    checkRes = mFragmentActivity.checkSelfPermission( perm.getPermissionName());
                }
